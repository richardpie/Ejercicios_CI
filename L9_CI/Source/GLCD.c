...
// Escriu el caracter c en la posicio (p,y) (pagina p= 0 a 7) (character column y= 0 a 20)
...
// Escriu el nombre enter i en la posicio (p,y) (page p= 0 a 7) (character column y= 0 a 20)
